  ...
  */
  ...
  _nextPageLoaded: function _nextPageLoaded(newObjects) {
    ...
    if (this.get('_firstPageLoaded')) {
      if (typeof this.updateInfinityModel === 'function' && this.updateInfinityModel !== Ember.Object.extend(RouteMixin).create().updateInfinityModel) {
        Ember.deprecate("EmberInfinity.updateInfinityModel is deprecated. " + "Please use EmberInfinity.afterInfinityModel.", false, { id: 'ember-infinity.updateInfinityModel', until: '2.1' });
