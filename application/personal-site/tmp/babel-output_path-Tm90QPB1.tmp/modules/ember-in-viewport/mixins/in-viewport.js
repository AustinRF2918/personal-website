...
export default Mixin.create({
  ...
  _setViewportEntered: function _setViewportEntered() {
    ...
    this._triggerDidAccessViewport(isInViewport(boundingClientRect, $contextEl.innerHeight(), $contextEl.innerWidth(), get(this, 'viewportTolerance')));
  ...
  _triggerDidScrollDirection: function _triggerDidScrollDirection() {
    ...
    var scrollDirection = checkScrollDirection(lastPositionForEl, newPosition, sensitivity);
